...
import com.collectivity.agricultural.model.enums.FederationOccupation;
...
public class FederationRepository {
            ...
            while (rs.next()) {
                if (federation == null) {
                    federation = Federation.builder()
                            .id(String.valueOf(rs.getString("federation_id")))
    ...
    private Member mapResultSetToMember(ResultSet rs) throws SQLException {
        return Member.builder()
                .id(String.valueOf(rs.getString("id_member")))
